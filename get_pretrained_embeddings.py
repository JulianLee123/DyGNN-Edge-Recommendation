...
def get_pretrained_embeddings(data_set_name):

    # Touch files first 
    np.save('../DyLink_Datasets/' + data_set_name + '/e_feat.npy', np.zeros(5))
    np.save('../DyLink_Datasets/' + data_set_name + '/r_feat.npy', np.zeros(5))
